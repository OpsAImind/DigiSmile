...
import "../../app/appointment/calender.scss"
...
const AppointmentForm = () => {
  ...
  const handleSubmit = async (values: any, setSubmitting: (v: boolean) => void) => {
              ...
              <Flex width="100%" flexDir="column" p={4}>
                ...
                <FormSelect
                  ...
                  options={[
                    ...
                    { label: "Pain/Problem", value: "pain_problem" },
                    { label: "Tooth Repair", value: "tooth_repair" },
                    { label: "Teeth Whitening", value: "teeth_whitening" },
                    { label: "Veeners", value: "veeners" },
                  ...
                  styles={{ marginBottom: "1.5rem" }}
                  handleChange={(value: string) => setFieldValue("description", value)}
                />
              </Flex>
              <Flex width="100%">
                <div className="date-picker">
                  ...
                  <DatePicker
                    ...
                    onChange={(date: any) => {
                      setFieldValue("appointment_date", moment(date).format("yyyy-MM-DD"));
                  ...
                  <Text
                    as="h4"
                    textAlign="center"
                    color={slotsStatus.success ? "green !important" : "red !important"}
                  >
                    {slotsStatus.text}
                  </Text>
                </div>
